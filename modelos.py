class FundoImobiliario:
    def __init__(self, codigo, segmento, cotacao_atual, ffo_yield, dividend_yield, p_pv, valor_mercado, liquidez,
...
class Estrategia:
    ...
    def aplica_estrategia(self, fundo: FundoImobiliario):
        ...
        if fundo.cotacao_atual < self.cotacao_atual_minima \
                ...
                or fundo.p_pv < self.p_vp_minimo\
